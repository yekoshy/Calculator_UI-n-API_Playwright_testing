...
- Name: calc_v2_test.spec.ts >> Calculator Tests >> Testcase NF-02: Missing Operand 1
...
Expected substring: "Empty input"
Received string:    "5"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#answer')
    3 × locator resolved to <span id="answer"></span>
      - unexpected value ""
    6 × locator resolved to <span id="answer">5</span>
      - unexpected value "5"
